...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        if (!eachUomOptional.isPresent() || !tableSpoonUomOptional.isPresent()
                || !teaSpoonUomOptional.isPresent() || !dashUomOptional.isPresent()
                || !pintUomOptional.isPresent() || !cupUomOptional.isPresent())
